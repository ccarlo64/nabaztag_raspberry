...
bus.write_byte_data(RFID,R_PARAM,cmdOff) #off rfid! test, if read must be 00
bus.write_byte_data(RFID,R_PARAM,cmdOn) #on rfid! test, if read must be 10
